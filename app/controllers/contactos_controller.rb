class ContactosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @contacto.update(contacto_params)
        format.html { redirect_to @contacto, notice: "Contacto was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to contactos_path, notice: "Contacto was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_contacto
      @contacto = Contacto.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def contacto_params
      params.expect(contacto: [ :nombre, :email, :mensaje ])
    end
end
